  ...
  return (
    <>
      <section className="relative min-h-screen overflow-hidden bg-ink text-ink-foreground">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-end px-4 pb-8 pt-24 sm:px-6 sm:pb-10 sm:pt-28 lg:px-8 lg:pb-12 lg:pt-32">
      ...
      <div className="mx-auto max-w-7xl space-y-12 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="rounded-3xl bg-brand-deep p-4 sm:p-8">
          <div className="grid gap-6 rounded-2xl bg-surface p-6 sm:p-8 md:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] md:items-center">
